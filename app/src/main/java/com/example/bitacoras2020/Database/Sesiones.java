...
public class Sesiones extends SugarRecord {
    String usuario="", contrasena="", fecha="", latitud="", longitud="", estatus="", hora="", statos="", isBunker="", isProveedor="", geofence="";
    /**
     * estatus 1 = checkin
     * estatus 2 = checkout
     */
    ...
    public Sesiones(String usuario, String contrasena, String fecha, String latitud, String longitud, String estatus, String hora, String statos, String isBunker, String isProveedor, String geofecne) {
